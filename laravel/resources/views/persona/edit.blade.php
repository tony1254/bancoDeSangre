@extends('layouts.app')
@section('title') {{'Edicion de Persona #'.$persona->id}}@stop
...
<input type="text" name="_method" value="PUT" hidden>
                  ...
                  <div class="row " >
                        ...
                        <div class="input-field col s6">
                           ...
                           <div class="input-field col s6">
                                <input placeholder="Ingrese Nombre de peso" id="peso" name="peso" type="text" class="validate peso"  value="{{$persona->peso}}"
